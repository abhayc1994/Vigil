...
public class steps {
   ...
   public void user_is_on_doa_home_page() {
   }

   @When("User selects service type as {string}")
   public void user_selects_service_type_as(String string) {
   }

   @When("Product as {string},{string}")
   public void product_as(String string, String string2) {
   }

   @Then("On Clicking OpenNow User should be Navigated to Basic InformationPage")
   public void on_clicking_open_now_user_should_be_navigated_to_basic_information_page() {
   }

   @When("User fills all Basic Information and clicks Next")
   public void user_fills_all_basic_information_and_clicks_next(
	   io.cucumber.datatable.DataTable dataTable) {
   }
   ...
   public void user_fills_details_for_cod_page_and_click_next(
	   io.cucumber.datatable.DataTable dataTable) {
   }
   ...
   public void type_of_product_should_be_returned_according_to_the_query_params_cust_type_as(
	   String string) {
   }
